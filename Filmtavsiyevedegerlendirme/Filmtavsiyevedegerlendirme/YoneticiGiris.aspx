<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YoneticiGiris.aspx.cs" Inherits="Filmtavsiyevedegerlendirme.YoneticiGiris" %>
...
<body>
    <form id="form1" runat="server">
        <div><h1>Yönetici Giriş Sayfası</h1>
            <table class="auto-style1">
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" CssClass="auto-style2" Text="Yonetici Adı:"></asp:Label>
                    </td>
                    <td>
